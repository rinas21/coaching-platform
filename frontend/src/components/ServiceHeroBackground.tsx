...
export default function ServiceHeroBackground() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 w-full h-full overflow-hidden z-0 bg-cream-brand/50">
      <div className="hero_bg absolute -inset-y-[20%] w-full h-[140%] bg-[url('/assets/images/about-page_hero-header.png')] bg-cover bg-center bg-no-repeat opacity-60 md:opacity-100" />
